    ...
    if (!currentQ) {
        return (
            <div className="p-10 flex flex-col items-center justify-center min-h-[50vh]">
                ...
                <Link href={`/${lang}/physics-small`} className="text-indigo-600 dark:text-indigo-400 hover:underline">返回专题选择</Link>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 md:p-10 min-h-screen flex flex-col">
            <div className="flex justify-between items-center mb-8 border-b border-slate-200 dark:border-slate-700 pb-4">
                <div>
                    <Link href={`/${lang}/physics-small`} className="text-sm text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 mb-2 flex items-center gap-1 font-medium group">
