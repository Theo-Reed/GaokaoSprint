        ...
        <div className="max-w-4xl mx-auto px-2 py-4 md:p-10 min-h-screen flex flex-col">
            ...
            <div className="flex justify-between items-center mb-6 md:mb-8 border-b border-slate-200 dark:border-slate-700 pb-4">
                ...
                <div className={`
                    ...
                    ${timer > 180 ? 'bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-200' : 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300'}
                `}>
                    <Clock size={20} />
                    {formatTime(timer)}
                </div>
            ...
            <div className="bg-white dark:bg-slate-900 shadow-lg rounded-2xl pt-4 md:pt-[29px] px-4 md:px-8 pb-8 mb-6 border border-slate-100 dark:border-slate-800 flex-grow relative overflow-hidden">
                <div className="flex flex-wrap items-center gap-2 mb-6 pb-4 border-b border-slate-100 dark:border-slate-700">
                    ...
                    <span className="inline-flex items-center px-4 py-1.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-sm md:px-3 md:py-1 md:text-xs font-medium rounded-full border border-slate-200 dark:border-slate-700">
                ...
                {currentQ.has_figure && (
                    <div className="my-6 flex flex-col items-center justify-center p-4">
                        <img 
                            src={`/math-images/${encodeURIComponent(`${currentQ.source}-${currentQ.question_number}.png`)}`} 
                            alt="题目插图" 
