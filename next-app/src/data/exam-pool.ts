...
export const EXAM_POOL: QuizQuestion[] = [
  ...
  { id: "emp_4", categoryId: "emphasis_it", question: "It is Tom ______ is to blame.", expected: ["who", "that"], explanationCN: "强调人 (Tom) -> 可用 who 或 that。", explanationEN: "When emphasizing a person (Tom), both \"that\" and \"who\" are acceptable connectors." },
